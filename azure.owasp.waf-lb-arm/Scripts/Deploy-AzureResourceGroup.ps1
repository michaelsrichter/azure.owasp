...
Param(
  ...
  [string] $TemplateFile = '..\Templates\LoadBalancedBarracudaWAFAndApp.json',
  [string] $TemplateParametersFile = '..\Templates\LoadBalancedBarracudaWAFAndApp.param.dev.json',
